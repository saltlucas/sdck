          ...
          <div class="grid-container">
            <?php if(get_sub_field('column')): ?>
              ...
              <?php while (have_rows('column')) : the_row(); ?>
                <div class="cell small-12 medium-6 <?php if(get_sub_field('background_image')): ?> cell-background-image <?php endif; ?>">
                  <?php if(get_sub_field('background_image')): ?>
                  <div class="background-image">
                    <?php
                      $image = get_sub_field('background_image');
        ...
        <div class="grid-container">
          ...
          if( have_rows('sponsor') ):
              ...
              <div class="cell sponsor-cell">
                <?php if(get_sub_field('sponsor_image')): ?>
                  <?php if(get_sub_field('sponsor_link')): ?>
                    <a style="display:block;" href="<?php  the_sub_field('sponsor_link');  ?>" title="<?php  the_sub_field('sponsor_title');  ?>">
                  <?php endif; ?>
                      <img class="sponsor-image" src="<?php  the_sub_field('sponsor_image');  ?>" alt="<?php  the_sub_field('sponsor_title');  ?>">
                  <?php if(get_sub_field('sponsor_link')): ?>
                    </a>
                  <?php endif; ?>
                <?php else: ?>
                  <h4 class="sponsor-title"><?php  the_sub_field('sponsor_title');  ?></h4>
                <?php endif; ?>
              </div>
              <?php endwhile;
          else :
